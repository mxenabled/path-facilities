...
```groovy
dependencies {
  api platform("com.mx.path-facilities:platform:5.2.0")
...
```groovy
dependencies {
  implementation "com.mx.path-facilities:store-redis:5.2.0"
  implementation "com.mx.path-facilities:store-vault:5.2.0"
  implementation "com.mx.path-facilities:encryption-service-vault:5.2.0"
  implementation "com.mx.path-facilities:encryption-service-jasypt:5.2.0"
  implementation "com.mx.path-facilities:message-broker-nats:5.2.0"
  implementation "com.mx.path-facilities:fault-tolerant-executor-resilience4j:5.2.0"
  implementation "com.mx.path-facilities:exception-reporter-honeybadger:5.2.0"
}
```
<!-- x-release-please-end -->
