...
```groovy
dependencies {
  api platform("com.mx.path-facilities:platform:2.0.0")
...
```groovy
dependencies {
  implementation "com.mx.path-facilities:store-redis:2.0.0"
  implementation "com.mx.path-facilities:store-vault:2.0.0"
  implementation "com.mx.path-facilities:encryption-service-vault:2.0.0"
  implementation "com.mx.path-facilities:encryption-service-jasypt:2.0.0"
  implementation "com.mx.path-facilities:message-broker-nats:2.0.0"
  implementation "com.mx.path-facilities:fault-tolerant-executor-resilience4j:2.0.0"
  implementation "com.mx.path-facilities:exception-reporter-honeybadger:2.0.0"
}
```
<!-- x-release-please-end -->
