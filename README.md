...
```groovy
dependencies {
  api platform("com.mx.path-facilities:platform:1.5.2")
...
```groovy
dependencies {
  implementation "com.mx.path-facilities:store-redis:1.5.2"
  implementation "com.mx.path-facilities:store-vault:1.5.2"
  implementation "com.mx.path-facilities:encryption-service-vault:1.5.2"
  implementation "com.mx.path-facilities:encryption-service-jasypt:1.5.2"
  implementation "com.mx.path-facilities:message-broker-nats:1.5.2"
  implementation "com.mx.path-facilities:fault-tolerant-executor-resilience4j:1.5.2"
  implementation "com.mx.path-facilities:exception-reporter-honeybadger:1.5.2"
}
```
<!-- x-release-please-end -->
